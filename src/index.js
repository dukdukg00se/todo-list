import * as contentFns from './modules/content-fns';
import * as displayFns from './modules/display-fns';
import * as listenerFns from './modules/listener-fns';
...
const displayCtrlr = (() => {
  ...
  displayFns.setMainPanel();
  displayFns.setProjPanel(data.projects);
  displayFns.hlNavSelection();

  listenerFns.addMenuToggListener('click', displayFns.
  toggleMenu);
  listenerFns.addNavListListeners('click', displayFns.manageNavResponse);
  listenerFns.addPageBtnListeners('click', displayFns.managePageBtns);
